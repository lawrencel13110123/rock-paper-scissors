  ...
  function changeDom1() {
    ...
    function changeDom2() {
      ...
      console.log('UserId: ' + gameObject.userId);
        ...
        console.log('Opponent Name: ' + gameObject.name);
        gameObject.userId = 2;
    ...
    function logic(){
      data.on('value', function(snapshot){
        ...
        if(gameObject.turn == 3 && snapshot.val().players[2].pick != ''){
          data.update({turn: 0});
            var p1 = gameObject.pick;
            var p2 = gameObject.pick2;
            console.log(gameObject.name + ' chose ' + p1);
            console.log(gameObject.name2 + ' chose ' + p2);
            var playersRef = data.child('players');
            var player1Ref = playersRef.child('1');
            var player2Ref = playersRef.child('2');
            if (p1 == p2) {
